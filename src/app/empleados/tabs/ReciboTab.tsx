    ...
    <div>
      ...
      {colaborador && resumen && (
        <div id="recibo-imprimible" style={{ background: "white", border: "1px solid #ddd", borderRadius: 10, padding: 24, maxWidth: 480 }}>
          ...
          <p style={{ fontSize: 15, fontWeight: 700, color: "#1A1A2E", marginTop: 2, marginBottom: 16 }}>
            Recibí de ZONA VIRTUAL SAS (CUIL: 30717400123) la suma de {fmtMoneyEmp(resumen.totalPagar)} en concepto de
            pago correspondiente al período {mesLabel}, por los conceptos detallados a continuación. Firmo en prueba
            de conformidad.
          </p>
          ...
          <div style={{ marginTop: 44, display: "flex", justifyContent: "space-between", gap: 24 }}>
            <div style={{ flex: 1, textAlign: "center" }}>
